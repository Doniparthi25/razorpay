...
import com.codingshuttle.razorpay.razorpay.operations.repository.DlqEventRepository;
...
public class WebhookDlqRecorder {
    ...
    public void recordConsumerFailed(ConsumerRecord<String, Map<String,Object>> record, String errror) {
